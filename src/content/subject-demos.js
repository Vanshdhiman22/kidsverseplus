...
const SUBJECTS = {
  literacy: {
    ...
    example: 'The red kite flew high in the sky. Ask what flew high, then look for the thing doing the action. It was the red kite.', rule: 'Ask: Who or what did the action? What happened? What is the big idea?',
    exampleWays: [
      { label: 'Try a plane', teaching_text: 'A plane flew high above the park. Point to the plane in the picture. Now ask: what flew high? The plane did. We used the same question with a new thing.', image_url: '/art/generated/literacy-plane-way-2.png', image_alt: 'A child points to a plane flying high above a park', nova_script: 'Look up at the plane. The plane is what flew high.', mini_question: q('A plane flew high above the park. What flew high?', ['A tree', 'The plane', 'A cloud', 'A car'], 'The plane', 'The plane is the thing that flew high.') },
      { label: 'Try a bird', teaching_text: 'A little bird flew high above the garden. Follow the child’s finger to the bird. Ask the same kind of question: what flew high? This time, the bird did.', image_url: '/art/generated/literacy-bird-way-3.png', image_alt: 'A child points to a bird flying high above a garden', nova_script: 'This time it is a bird. The bird is what flew high.', mini_question: q('A little bird flew high above the garden. What flew high?', ['The bird', 'A flower', 'A house', 'The sun'], 'The bird', 'The bird is the thing that flew high.') },
    ],
  ...
  evs: {
    ...
    exampleWays: [
      { label: 'Compare the two', teaching_text: 'Give the plant and the stone water. Over time the plant can grow new leaves, but the stone stays the same. Growing is a clue that something is living.' },
      { label: 'Ask three questions', teaching_text: 'Does it need water? Does it need food or air? Can it grow by itself? Use those clues to decide whether it is living.' },
    ],
  ...
  computer: {
    ...
    exampleWays: [
      { label: 'Act it out', teaching_text: 'Pretend you are the computer. Walk forward, turn right, and do the same steps again. Following the order helps you trace a square.' },
      { label: 'Check the order', teaching_text: 'Put each instruction on its own card. Read the cards from first to last, then check whether the shape closes. If not, find the step that is out of order.' },
    ],
  ...
  general: {
    ...
    exampleWays: [
      { label: 'Match the job', teaching_text: 'Start with what someone needs help with. Is it an illness, a fire, or a lesson? Match that need to the person whose job is to help.' },
      { label: 'Imagine a scene', teaching_text: 'Picture a classroom, a clinic, and a fire station. Think about the work done in each place to remember which helper to choose.' },
    ],
...
export function subjectDemoRaw(subject) {
  ...
  const steps = [
    ...
    { step_key: 'example', title: 'Watch the idea in action', teaching_text: data.example, explanation_ways: data.exampleWays, key_idea: data.rule, image_url: subject === 'literacy' ? '/art/generated/literacy-kite-way-1.png' : null, image_alt: subject === 'literacy' ? 'A child looks up at a red kite flying high above a park' : '', nova_script: `Let’s follow this example. ${data.example}`, mini_question: data.learn[1] },
