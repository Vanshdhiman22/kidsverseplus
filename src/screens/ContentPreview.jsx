...
export default function ContentPreview() {
  ...
  const openPreview = () => navigate('/missions/fractions/learn?subject=maths&contentPreview=1')
  ...
  return (
    <main className="min-h-screen bg-[#f5f5ff] px-6 py-10 text-ink">
      <div className="mx-auto max-w-[1100px]">
        ...
        <p className="mt-4 max-w-[720px] text-[17px] text-ink-2">Download the JSON package from Content Studio, then select it here. The three learning screens will use that package in this browser session.</p>
        ...
        {draft && <>
          ...
          <button type="button" onClick={openPreview} className="mt-6 rounded-2xl bg-violet-600 px-7 py-4 font-extrabold text-white transition hover:bg-violet-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-violet-300">Open learning screens →</button>
        </>}
